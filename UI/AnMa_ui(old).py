...
class Ui_AnMaForm(object):
    def setupUi(self, AnMaForm):
        ...
        # --- 💾 Nút LƯU EDGE MAP (dưới ảnh sau khi ẩn mã) ---
        self.btn_SaveEdge = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.btn_SaveEdge.setGeometry(QtCore.QRect(440, 380, 161, 41))
        self.btn_SaveEdge.setObjectName("btn_SaveEdge")
    ...
    def retranslateUi(self, AnMaForm):
        ...
        self.btn_SaveEdge.setText(_translate("AnMaForm", "💾 Lưu Edge Map"))
